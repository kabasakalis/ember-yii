...
$yii=(!APP_DEPLOYED)?dirname(__FILE__).DS.'..'.DS.'..'.DS.'frameworks'.DS .'yii_1.1.12'.DS .'framework'.DS .'yii.php':
//Server framework Path
 dirname(__FILE__).DS.'..'.DS.'frameworks'.DS .'yii_1.1.12'.DS .'framework'.DS .'yii.php';
